...
namespace LogisticDesk.UI.Componentes
{
    public class RJDatePicker : DateTimePicker
    {
        //Fields
        //-> Appearance
        private Color skinColor = Color.SteelBlue;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (StringFormat textFormat = new StringFormat())
            {
                ...
                //Draw text
                graphics.DrawString($"   {((_characterCasing == CharacterCasing.Upper) ? this.Text.ToUpper() : this.Text)}"//"   " + this.Text
                    , this.Font, textBrush, clientArea, textFormat);
