...
//{
//    class DataGridViewGrouper : Component, IGrouper
//    {
...
namespace LogisticDesk.UI.Componentes
{
    ...
    public class DataGridViewGrouper : Component, IGrouper
    {
        ...
        public DataGridView DataGridView
        {
            ...
            set
            {
                ...
                if (grid != null)
                {
                    ...
                    /*TODO comentado 04/05/2021 9:15 am*/
        ...
        void grid_SelectionChanged(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(ex.Message, "grid_SelectionChanged");
            }
        }
        ...
        void grid_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                MessageBox.Show(ex.Message, "CellDoubleClick");
            }
        }
        ...
        void PaintGroupRow(DataGridViewRowPrePaintEventArgs e)
        {
...

            {
                ...
                using (var fb = new SolidBrush(info.ForeColor))
                {
                    ...
                    {
                        using (var f =
                            new Font(info.Font.FontFamily, info.Font.Size , FontStyle.Bold)
                            //new Font("Century Gothic", 9, System.Drawing.FontStyle.Regular, GraphicsUnit.Point)
                            )
                        {
